var main = [
  ...
  function($log, $sce, VideoUtils) {
    ...
    var designPanel = [
      ...
      '          </div>',
      '          <br>',
      '          <div class="preview-thumbnail-view">',
      '          ' + previewVideo,
      '          </div>',
      ...
      '              <tr>',
      '                <td class="btn btn-default video-icon-td"',
      ...
      '                </td>',
      '                <td class="video-label-td">small<br>{{dimensions[fullModel.model.config.ratioType]["small"]}}',
      '                </td>',
      '              </tr>',
      '              <tr>',
      '                <td class="btn btn-default  video-icon-td"',
      ...
      '                </td>',
      '                </td>',
      '                <td class="video-label-td">medium<br>{{dimensions[fullModel.model.config.ratioType]["medium"]}}',
      '                </td>',
      '              </tr>',
      '              <tr>',
      '                <td class="btn btn-default  video-icon-td"',
      ...
      '                </td>',
      '                </td>',
      '                <td class="video-label-td">large<br>{{dimensions[fullModel.model.config.ratioType]["large"]}}',
      '                </td>',
      '              </tr>',
      '            </table>',
      '          </div>',
