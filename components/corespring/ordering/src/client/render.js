...
var main = ['$compile', '$log', '$modal', '$rootScope', '$timeout',
  function($compile, $log, $modal, $rootScope, $timeout) {
    ...
    var answerArea = [
      ...
      '    <div ng-repeat="o in originalChoices" class="choice-wrapper" data-drop="true" ng-if="!showCorrectResponse()"',
    ...
    var inplaceTemplate = [
      ...
      '        <ul class="clearfix" ng-model="local.choices" ui-sortable="sortableOptions" ng-show="!showCorrectResponse()">',
