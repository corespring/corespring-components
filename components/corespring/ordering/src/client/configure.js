    ...
    function(ChoiceTemplates,
      ...
      function designTemplate() {
        ...
        return [
          ...
          '<div class="placement-chooser">',
          '  <radio id="inplaceRadio" ng-model="model.config.placementType" value="inPlace">In Place</radio>',
          '  <radio id="placementRadio" ng-model="model.config.placementType" value="placement">Placement</radio>',
          '</div>',

          '<p class="intro" ng-if="model.config.placementType == \'placement\'">',
          '  Placement area ordering requires the student to drag their choices to a placement area to order. Not all tiles must be used.<br>',
          '  Drag & drop the tiles to the placement area to set the correct order. Students will see a shuffled version of the choices.',
          '</p>',
          '<p class="intro" ng-if="model.config.placementType != \'placement\'">',
          '  In place ordering asks the student to order within a list. The student must order all of the choices.<br>',
          '  Drag & drop the tiles to set the correct order. Students will see a shuffled version of the choices.',
          '</p>',
          '<table class="choice-columns"><tr>',
          '  <td>',
          '    <input ng-if="model.config.placementType == \'placement\'" class="prompt" type="text" ng-model="model.config.choiceAreaLabel"',
          '      placeholder="Enter a label or leave blank"/>',
          '    <ul class="sortable-choices draggable-choices {{model.config.placementType}}" ui-sortable="choicesSortableOptions"',
          ...
          '          </div>',
          '        </div>',
          '        <div ng-if="model.config.placementType == \'placement\'" class="remove-after-placing">',
          '          <checkbox id="moveOnDrag{{$index}}" ng-model="choice.moveOnDrag">Remove tile after placing</checkbox>',
          '        </div>',
          ...
          '  </td>',
          '  <td ng-if="model.config.placementType == \'placement\'">',
          ...
          '  </td>',
          '</tr></table>',
          '<div ng-if="model.config.placementType == \'placement\'">',
