   ...
   function($timeout,
     ...
     "use strict";
      ...
      var designPanel = [
        ...
        '        shuffled version of the choices. Students will order the choices in place, unless the include',
        '        placement area option is selected.',
        '      </p>',
        '    </div>',
        '  </div>',
        '  <div class="row choices-row">',
        '    <div class="col-xs-12">',
        '      <label class="enter-choices">Enter Choices</label>',
        ...
        '        <li class="sortable-choice col-md-7 col-md-offset-2-5" data-choice-id="{{choice.id}}" ng-repeat="choice in model.choices"',
        ...
        '            </div>',
        '          </div>',
        '          <div class="remove-after-placing" ng-style="{\'visibility\': config.placementToggle ? \'visible\':\'hidden\'}">',
        ...
        //TODO: scope the config like so: wiggi-wiz-config="corespring-components.ordering" that'd fallback to the default if not present
        '          <div ng-show="active[$index]" ng-model="choice.label" mini-wiggi-wiz=""  features="extraFeaturesForChoices"',
        ...
        '    <div class="row" ng-style="{\'visibility\': config.placementToggle ? \'visible\':\'hidden\'}">',
        '      <div class="col-xs-12">',
