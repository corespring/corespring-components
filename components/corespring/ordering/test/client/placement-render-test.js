  ...
  describe('placement ordering', function() {
    ...
    describe('vertical layout', function() {
      ...
      it('show correct answer button are visible after submitting', function() {
        ...
        container.elements['1'].setResponse({correctness: 'incorrect', answer: ['c3', 'c4'], correctResponse: ['c1', 'c2']});
        scope.$digest();
      ...
      it('correct answer is visible after submitting an incorrect answer', function() {
        setModelAndDigest(horizontalModel);
        setResponseAndDigest({correctness: 'incorrect', answer: ['c3', 'c4'], correctResponse: ['c1', 'c2']});
    ...
    describe('undo / start over', function() {
      ...
      it('undo undoes the last step', function() {
        setModelAndDigest(verticalModel);
        scope.landingPlaceChoices = {0: 'c1', 1: 'c2'};
        scope.$digest();
        scope.landingPlaceChoices = {0: 'c2', 1: 'c1'};
        scope.$digest();
        scope.undo();
        scope.$digest();
        expect(scope.landingPlaceChoices).toEqual({0: 'c1', 1: 'c2'});
      });

      it('undo undoes multiple steps', function() {
        setModelAndDigest(verticalModel);
        scope.landingPlaceChoices = {0: 'c1', 1: 'c2', 2: 'c3', 3: 'c4'};
        scope.$digest();

        scope.landingPlaceChoices = {0: 'c2', 1: 'c1', 2: 'c3', 3: 'c4'};
        scope.$digest();

        scope.landingPlaceChoices = {0: 'c2', 1: 'c3', 2: 'c1', 3: 'c4'};
        scope.$digest();

        scope.landingPlaceChoices = {0: 'c2', 1: 'c3', 2: 'c4', 3: 'c1'};
        scope.$digest();

        scope.undo();
        scope.$digest();
        expect(scope.landingPlaceChoices).toEqual({0: 'c2', 1: 'c3', 2: 'c1', 3: 'c4'});

        scope.undo();
        scope.$digest();
        expect(scope.landingPlaceChoices).toEqual({0: 'c2', 1: 'c1', 2: 'c3', 3: 'c4'});

        scope.undo();
        scope.$digest();
        expect(scope.landingPlaceChoices).toEqual({0: 'c1', 1: 'c2', 2: 'c3', 3: 'c4'});
      });
      ...
      it('start over restores original state', function() {
        ...
        scope.landingPlaceChoices = {0: 'c1', 1: 'c2', 2: 'c3'};
        scope.$digest();

        scope.landingPlaceChoices = {0: 'c2', 1: 'c1', 2: 'c3'};
        scope.$digest();

        scope.landingPlaceChoices = {0: 'c2', 1: 'c3', 2: 'c1'};
        scope.$digest();

        scope.landingPlaceChoices = {0: 'c2', 1: 'c3', 2: 'c4'};
        scope.$digest();
