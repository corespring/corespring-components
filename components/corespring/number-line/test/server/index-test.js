...
describe('number line', function() {
  ...
  describe('feedback', function() {
    ...
    it('correct item has correct feedback message and class', function() {
      var outcome = server.respond(component, correctAnswer, helper.settings(true, true, true));
    ...
    it('partially correct item has partial feedback message and class', function() {
      ...
      var outcome = server.respond(component, partiallCorrectAnswer, helper.settings(true, true, true));
  ...
  describe('partial scoring', function() {
    ...
    it('score should be percentage if answer is partially correct', function() {
      ...
      var outcome = server.respond(pComponent, answer, helper.settings(true, true, true));
    ...
    it('score should be 1 if answer is incorrect', function() {
      var outcome = server.respond(pComponent, correctAnswer, helper.settings(true, true, true));
      expect(outcome).to.have.property("score").eql(1);
    });
  });
});