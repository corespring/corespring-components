    ...
    function(ChoiceTemplates,
      ...
      function designTemplate() {
        ...
        return [
          ...
          '  <input id="inplaceRadio" type="radio" ng-model="model.config.placementType" value="inPlace" /><label for="inplaceRadio">In Place</label>',
          '  <input id="placementRadio" type="radio" ng-model="model.config.placementType" value="placement"/><label for="placementRadio">Placement</label>',
          '</div>',
