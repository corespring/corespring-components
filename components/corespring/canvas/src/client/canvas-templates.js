    ...
    function CanvasTemplates() {
      ...
      this.configGraph = function() {
        return [
          ...
          labelWithInput({ label: 'Snap Frequency:', modelKey: 'domainSnapValue', inputType: "number", placeholder: '{{defaults.domainSnapValue}}' }),
          '      </div>',
          '      <div class="config-form-row">',
          ...
          labelWithInput({ label: 'Snap Frequency:', modelKey: 'rangeSnapValue', inputType: "number", placeholder: '{{defaults.rangeSnapValue}}' }),
          '      </div>',
          '      <div class="config-form-row">',
