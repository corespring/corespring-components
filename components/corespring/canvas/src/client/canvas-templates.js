    ...
    function CanvasTemplates() {
      ...
      this.configDisplay = function(showInputs) {
        ...
        return [
          ...
          '        <h3>Display</h3>',
          '        <div class="config-form-row">',
          labelWithInput({ label: 'Graph Label (top) Optional', modelKey: 'graphTitle', placeholder: '{{defaults.graphTitle}}' }),
          '        </div><br/> ',
          '        <div class="config-form-row">',
          labelWithInput({ label: 'Graph label (left) Optional', modelKey: 'rangeLabel', placeholder: "{{defaults.rangeLabel}}" }),
          '        </div><br />',
          '        <div class="config-form-row">',
          labelWithInput({ label: 'Graph Label (bottom) Optional', modelKey: 'domainLabel', placeholder: '{{defaults.domainLabel}}' }),
          '        </div><br />',
          '        <div class="config-form-row">',
