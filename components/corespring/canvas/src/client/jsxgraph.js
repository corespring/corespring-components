      ...
      link: function(scope, elem, attr) {
        ...
        var canvasAttrs = {
          ...
          domain: {
            ...
            min: parseInt(attr.domainmin ? attr.domainmin : -10, 10),
            max: parseInt(attr.domainmax ? attr.domainmax : 10, 10),
          ...
          range: {
            ...
            min: parseInt(attr.rangemin ? attr.rangemin : -10, 10),
            max: parseInt(attr.rangemax ? attr.rangemax : 10, 10),
