var main = ['ComponentDefaultData',
  function(ComponentDefaultData) {
    ...
    var graphAttributesBlock = [
      ...
      labelWithInput({ label: 'Label Pattern:', modelKey: 'domainLabelPattern', placeholder: '{{defaults.domainLabelPattern}}' }),
      '       </div><br />',
      '       <div class="config-form-row">',
      '         <h4>Range</h4>',
      '       </div>',
      ...
      labelWithInput({ label: 'Label Pattern:', modelKey: 'rangeLabelPattern', placeholder: '{{defaults.rangeLabelPattern}}' }),
      '        </div><br />',
      '       <div class="config-form-row">',
