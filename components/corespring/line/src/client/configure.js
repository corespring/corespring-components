var main = ['ComponentDefaultData',
  function(ComponentDefaultData) {
    ...
    var displayBlock = [
      ...
      labelWithInput({ label: 'Add padding to graph', modelKey: 'graphPadding', inputType: "number", inputClass: 'input-number', labelClass: 'input-number-label', placeholder: '{{defaults.graphPadding}}', labelSize: 4, size: 2, extraProperties: "min='0' max= '100' step='25'" }),
