var main = ['ComponentDefaultData',
  function(ComponentDefaultData) {
    ...
    var displayBlock = [
      ...
      '        </div>',
      '        <div class="row config-form-row"><br />',
      labelWithInput({ label: 'Add padding to graph', modelKey: 'graphPadding', inputType: "number", inputClass: 'input-number', placeholder: '{{defaults.graphPadding}}', labelSize: 4, size: 2, extraProperties: "min='0' max= '100' step='25'" }),
      '        </div>',
      '        <div class="config-form-row">',
    ...
    var graphAttributesBlock = [
      ...
      '     <form class="form-horizontal" role="form">',
      '       <div class="config-form-row">',
      labelWithInput({ label: 'Domain Minimum:', modelKey: 'domainMin', inputType: "number", placeholder: '{{defaults.domainMin}}' }),
      labelWithInput({ label: 'Domain Maximum:', modelKey: 'domainMax', inputType: "number", placeholder: '{{defaults.domainMax}}' }),
      '       </div>',
      '       <div class="config-form-row">',
      labelWithInput({ label: 'Domain Label:', modelKey: 'domainLabel', placeholder: '{{defaults.domainLabel}}' }),
      '       </div>',
      '       <div class="config-form-row">',
      labelWithInput({ label: 'Range Minimum:', modelKey: 'rangeMin', inputType: "number", placeholder: '{{defaults.rangeMin}}' }),
      labelWithInput({ label: 'Range Maximun:', modelKey: 'rangeMax', inputType: "number", placeholder: '{{defaults.rangeMax}}' }),
      '       </div>',
      '       <div class="config-form-row">',
