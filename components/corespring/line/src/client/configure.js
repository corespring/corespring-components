var main = [
  function() {
    ...
    var graphAttributes = [
      ...
      '         </div>',
      '         <div class="col-sm-6">',
      '           <checkbox id="showInputs" ng-model="fullModel.model.config.showInputs">Show Point Inputs on the Graph</checkbox>',
      '         </div>',
      '       </div>',
      '     </form>',
      '  </div>',
    ...
    var linesBlock = [
      ...
      '       <div class="config-form-row">',
      '         <div class="col-sm-8">',
      '           <checkbox id="exhibitOnly" value="absent" ng-model="fullModel.model.config.exhibitOnly">',
