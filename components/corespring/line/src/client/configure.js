var main = [
  ...
  function(ComponentDefaultData, CanvasTemplates) {
    ...
    var linesBlock = [
      ...
      '    <strong>Line equations must be in y=mx+b form. Only whole number coordinates can be plotted.</strong>',
      '  </div>',
      '</div>',
      ...
      '  <div class="col-md-6"><strong>Initial View (Optional)</strong></div>',
      '</div>',
