  ...
  function($compile, $modal, $rootScope) {
    return {
      template: [
        ...
        "   </div>",
        "   <div>",
        "       <div id='inputs' class='col-sm-5' ng-show='showInputs' style='margin-right: 17px;'>",
        ...
        "          </div>",
        "      </div>",
        "      <div ng-show='showInputs' class='scale-display'>scale={{scale}}</div>",
        "      <div class='clearfix'> </div>",
        "      <div class='scale-display' ng-show='showInputs'>",
