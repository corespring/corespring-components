  ...
  function(Calculator) {
    ...
    function template() {
      return [
        ...
        '          ng-mouseup="mouseup(buttons[button])">',//'<div ng-bind-html-unsafe="buttons[button]"></div>',
        '        <svg-icon class="toggle-icon show-state" category="calculator" key="calc-{{buttons[button].id}}"></svg-icon>',
        '      </button>',
        '    </div>',
        '  </div>',
        '</div>'
