var main = ['ComponentDefaultData',
  function(ComponentDefaultData) {
    ...
    var linesBlock = [
      '<div class="row" ng-hide="fullModel.model.config.exhibitOnly">',
      ...
      '              <span class="input-group-addon">y = </span><input type="text" class="form-control" placeholder="mx+b" ng-model="line.function" />',
      '            </div>',
      '          </div>',
      '          <div class="col-md-4">',
      '            <div class="col-md-9 input-group">',
