...
function configureTextEntry(
  ...
  function template() {
    return [
      ...
      '        <p>Additional correct answers may be added by clicking <b>enter/return</b> between answers.</p>',
      '      </div>',
      '    </div>',
      ...
      '        <p>Additional partially correct answers may be added by clicking <b>enter/return</b> between answers.</p>',
      '      </div>',
      '    </div>',
      '    <div cs-text-entry-response-input ',
