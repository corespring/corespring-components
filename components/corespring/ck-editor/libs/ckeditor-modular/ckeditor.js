...
"indent", "blocks", "align", "bidi"]
  ...
  CKEDITOR.config.plugins = 'dialogui,dialog,clipboard,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo';
  ...
  (function() {
    ...
    if (CKEDITOR.env.hidpi) setIcons('copy-rtl,0,,copy,24,,cut-rtl,48,,cut,72,,paste-rtl,96,,paste,120,,indent-rtl,144,,indent,168,,outdent-rtl,192,,outdent,216,,anchor-rtl,240,,anchor,264,,link,288,,unlink,312,,bulletedlist-rtl,336,,bulletedlist,360,,numberedlist-rtl,384,,numberedlist,408,,redo-rtl,432,,redo,456,,undo-rtl,480,,undo,504,', 'icons_hidpi.png');
    else setIcons('copy-rtl,0,auto,copy,24,auto,cut-rtl,48,auto,cut,72,auto,paste-rtl,96,auto,paste,120,auto,indent-rtl,144,auto,indent,168,auto,outdent-rtl,192,auto,outdent,216,auto,anchor-rtl,240,auto,anchor,264,auto,link,288,auto,unlink,312,auto,bulletedlist-rtl,336,auto,bulletedlist,360,auto,numberedlist-rtl,384,auto,numberedlist,408,auto,redo-rtl,432,auto,redo,456,auto,undo-rtl,480,auto,undo,504,auto', 'icons.png');
  })();
