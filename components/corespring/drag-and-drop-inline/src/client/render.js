var main = ['$compile', '$log', '$modal', '$rootScope', '$timeout',
  function($compile, $log, $modal, $rootScope, $timeout) {
    ...
    var answerArea = [
      ...
      '          <div style="display: inline-block" answer-area class="inline" landingId="{{c.id}}" layout="inline"></div>',
    ...
    var choiceArea = function() {
      return [
        ...
        '                   jqyoui-draggable="{placeholder: {{placeholderForChoice(o)}}, onStart: \'onStart\'}"',
        '                   data-id="{{o.id}}">',
    ...
    var tmpl = [
      '<div class="view-drag-and-drop-inline">',
