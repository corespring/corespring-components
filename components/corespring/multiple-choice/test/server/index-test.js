...
describe('single-choice server logic', function() {
  ...
  return describe('respond', function() {
    it('should not show any feedback', function() {
      ...
      return response.should.eql(expected);
    });
    ...
    return it('should respond to an incorrect response and show feedback for 1 incorrect and 1 correct', function() {
      var expected, response;
