var main = [
  ...
  function(
    ...
    var choices = [
      ...
      '<div class="form-row">',
      '  <span class="form-label">Choice Type:</span>',
      ...
      '    </select>',
      '  </span>',
      '  <span class="form-column" ng-if="model.config.choiceType == \'radio\'">This option allows students to select one correct answer. You may, however, set more than one answer as correct if you choose.</span>',
      '  <span class="form-column" ng-if="model.config.choiceType == \'checkbox\'">This option allows students to select more than one correct answer. You may, however, set only one correct answer if you choose.</span>',
      '</div>',
      '<div class="form-row">',
      '  <span class="form-label">Choice Labels:</span>',
      '  <span class="form-input">',
