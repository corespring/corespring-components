var main = [
  ...
  function(
    ...
    var designTemplate = [
      ...
      '                    <radio ng-model="$parent.fbSelFeedbackType" value="none">No feedback</radio>',
      '                  </li>',
      '                  <li class="radio-inline">',
      '                    <radio ng-model="$parent.fbSelFeedbackType" value="custom">Customized Feedback</radio>',
      '                  </li>',
      '                </ul>',
      '                <input class="form-control" type="text" disabled="true"',
      '                    placeholder="No feedback will be presented to the student" />',
      '              </div>',
      '            </div>',
      '          </div>',
      '        </div>',
