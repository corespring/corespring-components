var main = [
  ...
  function($log, ServerLogic, MathJaxService) {
    ...
    var designPanel = [
      ...
      '           <h5>Expression</h5>',
      "           <p>Enter the expression against which the the student's response will be evaluated. Note that <i>y</i>",
      "           is the dependent variable and f(<i>x</i>) is some function where <i>x</i> is the independent variable.</p>",
      '         </div>',
